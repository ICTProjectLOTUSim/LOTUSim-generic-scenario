...
@file pha.py
@author Naval Group
@brief Defines the Pha agent class for simulation.
@version 0.1
@date 2025-10-08
...
class Pha(Agent):
    """
    Pha surface vessel agent in the simulation.

    Inherits from the base Agent class. Initializes Pha-specific parameters,
    ...
    def lotus_param(self) -> str:
        """
        Generate the LOTUSim-compatible parameter string for Pha.
