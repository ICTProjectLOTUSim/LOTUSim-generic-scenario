...
@file lrauv.py
@author Naval Group
@brief Defines the Lrauv agent class for simulation.
@version 0.1
@date 2025-10-08
...
class Lrauv(Agent):
    ...
    Inherits from the base Agent class and initializes the Lrauv-specific
    ...
    def __init__(self, sdf_string: str, world_name: str, xdyn_enabled: bool):
        ...
        self.model_name = "lrauv"
        self.renderer_type_name = self.model_name
        if xdyn_enabled:
            self.xdyn_port = 12346
    ...
    def lotus_param(self) -> str:
        """
        Generate the LOTUSim-compatible parameter string for LRAUV.
        ...
        return utils.generate_lotus_param(
            ...
            thrusters=["propeller"],  # specific thruster names
